...
GLfloat lightDissuse[] = {1.0f, 0.0f, 0.0f, 1.0f};
GLfloat lightSpecular[] = {1.0f, 0.0f, 0.0f, 1.0f};
GLfloat lightPosition[] = {0.0f, 8.0f, 1.0f, 1.0f};         //Directional Light
GLfloat lightDirection[] = {0.0f, -2.0f, 0.0f};
GLfloat lightCutoff = 45.0f;
GLfloat lightExponent = 2.0f;

GLUquadric *mySphere = NULL;
...
void CreateWindow(void) {
	...
	XStoreName(gpDisplay, gWindow, "Spot Light");
...
int initialize(void) {
    ...
    glLightfv(GL_LIGHT0, GL_DIFFUSE, lightDissuse);
...
void display(void) {
    ...
    gluSphere(mySphere, 0.5f, 100, 100);
