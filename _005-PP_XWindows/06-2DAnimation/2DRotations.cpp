...
GLfloat fRotAngleTriangle = 0.0f, fRotAngleRect = 0.0f;
...
void display(void) {
    ...
    rotationMat = rotate(fRotAngleTriangle, 0.0f, 1.0f, 0.0f);
    
    modelViewMat = modelViewMat * translateMat * rotationMat;
    ...
    rotationMat = rotate(fRotAngleRect, 1.0f, 0.0f, 0.0f);
