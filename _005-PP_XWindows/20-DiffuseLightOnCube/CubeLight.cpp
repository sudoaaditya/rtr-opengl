...
GLuint vaoCube, vboCubePos, vboCubeNorm;
GLuint mvUniform;
...
int initialize(void) {
    ...
    mvUniform = glGetUniformLocation(gShaderProgObj, "u_mvp_matrix");
    ...
    GLfloat cubeVertices[] = {1.0f, 1.0f, 1.0f, -1.0f, 1.0f, 1.0f, -1.0f, -1.0f, 1.0f, 1.0f, -1.0f, 1.0f, //f
                                1.0f, 1.0f, -1.0f, -1.0f, 1.0f, -1.0f, -1.0f, -1.0f, -1.0f, 1.0f, -1.0f, -1.0f, //b
                                1.0f, 1.0f, -1.0f, -1.0f, 1.0f, -1.0f, -1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, //r
                                1.0f, -1.0f, -1.0f, -1.0f, -1.0f, -1.0f, -1.0f, -1.0f, 1.0f, 1.0f, -1.0f, 1.0f, //l
