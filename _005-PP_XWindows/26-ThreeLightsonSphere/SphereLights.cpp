...
GLfloat lightAngle = 0.0f, Radius = 500.0f;
...
void CreateWindow(void) {
	...
	XStoreName(gpDisplay, gWindow, "ADS_PerFragmentLighting!");
...
int initialize(void) {
    ...
    laZeroUniform = glGetUniformLocation(gShaderProgObj, "u_laZero");
    ldZeroUniform = glGetUniformLocation(gShaderProgObj, "u_ldZero");
    lsZeroUniform = glGetUniformLocation(gShaderProgObj, "u_lsZero");
    lightZeroPosUniform = glGetUniformLocation(gShaderProgObj, "u_lightPosZero");
    laOneUniform = glGetUniformLocation(gShaderProgObj, "u_laOne");
    ldOneUniform = glGetUniformLocation(gShaderProgObj, "u_ldOne");
    lsOneUniform = glGetUniformLocation(gShaderProgObj, "u_lsOne");
    lightOnePosUniform = glGetUniformLocation(gShaderProgObj, "u_lightPosOne");
    ...
    lightTwoPosUniform = glGetUniformLocation(gShaderProgObj, "u_lightPosTwo");
