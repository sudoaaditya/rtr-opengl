package com.amk_rtr.ogl_3danim;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    private int vbo_pyramidColor[] = new int[1];

    private int vao_cube[] = new int[1];
    private int vbo_cubePos[] = new int[1];
    private int vbo_cubeColor[] = new int[1];

    private int mvpUniform;
    private float perspectiveProjMat[] = new float[16];

    private float fPyramidRotAngle = 0.5f;
    private float fCubeRotAngle = 0.5f;
    ...
    private void initialize() {
        ...
        GLES32.glGenBuffers(1, vbo_pyramidColor, 0);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vbo_pyramidColor[0]);
        FloatBuffer colBuffer = createFloatBuffer(pyramidColor);
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, (pyramidColor.length *4), colBuffer, GLES32.GL_STATIC_DRAW);
        ...
        GLES32.glGenBuffers(1, vbo_cubeColor, 0);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vbo_cubeColor[0]);
        FloatBuffer colBuff = createFloatBuffer(cubeColor);
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, (cubeColor.length * 4), colBuff, GLES32.GL_STATIC_DRAW);
        GLES32.glVertexAttribPointer(GLESMacros.AMC_ATTRIBUTE_COLOR, 3, GLES32.GL_FLOAT, false, 0, 0);
        GLES32.glEnableVertexAttribArray(GLESMacros.AMC_ATTRIBUTE_COLOR);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);
    ...
    private void uninitialize() {
        ...
        if(vbo_pyramidColor[0] != 0) {
            GLES32.glDeleteBuffers(1, vbo_pyramidColor, 0);
            vbo_pyramidColor[0] = 0;
        }
        ...
        if(vbo_cubeColor[0] != 0) {
            GLES32.glDeleteBuffers(1, vbo_cubeColor, 0);
            vbo_cubeColor[0] = 0;
        }
