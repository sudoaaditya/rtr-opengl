package com.amk_rtr.ogl_tweakedsmiley;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    private void display() {
        ...
        float rectTexCoords[] = new float[8];
        ...
        FloatBuffer texBuff = createFloatBuffer(rectTexCoords);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER,vbo_rectangleTex[0]);
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, (rectTexCoords.length*4), texBuff, GLES32.GL_DYNAMIC_DRAW);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);
