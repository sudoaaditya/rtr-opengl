...
var matShineUniform;
var lPressedUnifrom;
var vertexLightingUniform;
var fragmentLightingUniform;
...
var bLighting = false;
var bVertexLight = true;
var bFragmentLight = false;
...
;
    ...
    vertexLightingUniform = gl.getUniformLocation(shaderProgObj, "u_vertexLighting");
    fragmentLightingUniform = gl.getUniformLocation(shaderProgObj, "u_fragmentLighting");
...
const display = function() {
    ...
    if(bLighting == true) {
        ...
        if(bVertexLight == true) {
            gl.uniform1i(vertexLightingUniform, 1);
            gl.uniform1i(fragmentLightingUniform, 0);
        }
        else if(bFragmentLight == true) {
            gl.uniform1i(vertexLightingUniform, 0);
            gl.uniform1i(fragmentLightingUniform, 1);
        }

        gl.uniform3fv(laUniform, lightAmbient);f
...
const keyDown = function(event) {
    ...
    switch(event.keyCode) {
        ...
        case 70:
            //F
            bFragmentLight = bFragmentLight == true ? false : true;
            break;
        ...
        case 86:
            //V
            bVertexLight = bVertexLight == true ? false : true;
            break;
