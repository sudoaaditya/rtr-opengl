...
GLuint vao_triangle = 0, vbo_triangle = 0;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR szCmdLine, int iCmdShow) {
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
                          szAppName,
                          TEXT("PP_PerspectiveTriangleReactangle"),
                          WS_OVERLAPPEDWINDOW |
                          WS_CLIPCHILDREN|
                          WS_CLIPSIBLINGS|
                          WS_VISIBLE,
...
/*     GLfloat rectangleVert[] = {1.0f, 1.0f, 0.0f, -1.0f, 1.0f, 0.0f, -1.0f, -1.0f, 0.0f, 1.0f, -1.0f, 0.0f};
 */
