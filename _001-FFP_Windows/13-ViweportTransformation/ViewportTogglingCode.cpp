...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	WNDCLASSEX wndclass;
	HWND hwnd;
	TCHAR szApp[] = TEXT("ViewPortToggling");
	int iRet = 0;
	bool bDone = false;

	if (fopen_s(&fptr, "VpToggLog.txt", "w") != 0) {
