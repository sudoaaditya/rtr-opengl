...
#include<gl/GL.h>
#include<gl/glu.h>
#include"Teapot_Code_Files/OGL.h"
#include"ResHeader.h"
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
    ...
    if(fopen_s(&fptr,"_LightCubeLog.txt","w") != 0) {
...
int initialize(void) {
    ...
    if(loadTexture(&iTex_Marble, MAKEINTRESOURCE(MY_TEAPOT)) == FALSE) {
        return(-5);
    }
    else {
        fprintf(fptr, "Texture Marbe Loaded Successfully!!..\n");
    }
...
void uninitialize(void){
    ...
    if(iTex_Marble) {
        glDeleteTextures(1, &iTex_Marble);
        iTex_Marble = 0;
    }
