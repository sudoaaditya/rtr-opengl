...
int initialize(void) {
    ...
    listBase = CreateBitmapFont("Trebuchet MS", 30);
    if(listBase == 0) {
        return(-5);
    }
    else {
        fprintf(fptr, "Font Screated Successfully!\n");
    }
...
unsigned int CreateBitmapFont(char *fontName, int fontSize) {
    ...
    fontBase = glGenLists(96);
		...
		hMyFont = CreateFont(60, 25, 0, 0, FW_BOLD,
			NULL, NULL, NULL, NULL,
...
void RenderFont(GLfloat posX, GLfloat posY, GLfloat posZ, unsigned int listBase, char *str) {
...
void display(void) {
    ...
    void RenderFont(GLfloat, GLfloat, GLfloat, unsigned int, char*);
    ...
    RenderFont(0.0f, 1.2f, 0.0f, listBase, "You Live Here.");
